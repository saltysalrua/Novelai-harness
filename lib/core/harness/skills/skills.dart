...
提示词怎么写：
- 标签与自然语言配合：确切且标准的特征（角色名、作品名、标准发型发色瞳色、经典服装、基础动作）优先用标准 Danbooru 标签快速锁定；复杂的环境氛围、光影质感、细腻表情神态与漫画分镜，用生动连贯的自然语言补充。
...
特殊形态与限定换装：
- 角色若带有特定形态标签（如 swimsuit、dress、maid 等），这类标签本身就已经绑定了专属的衣服和发型。
- 做法：用了形态标签后，切勿再额外添加原版默认服装或原版发型标签，避免两套衣服与发型在画面中打架撕裂。
